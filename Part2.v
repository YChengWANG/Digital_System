...
//=======================================================
//  Structural coding 
   assign HEX1[0] = SW[3]&(SW[1]|SW[2]);
	assign HEX1[1] = 0;
	assign HEX1[2] = 0; 
	assign HEX1[3] = SW[3]&(SW[1]|SW[2]);
	assign HEX1[4] = SW[3]&(SW[1]|SW[2]);
	assign HEX1[5] = SW[3]&(SW[1]|SW[2]);
	assign HEX1[6] = 1;
	assign HEX1[7] = 1;
	...
	assign HEX0[5] = SW[3]&SW[2]&(~SW[1]) | ~SW[2]&SW[1]&SW[0] | ~SW[3]&(~SW[2])&SW[0] | ~SW[3]&(~SW[2])&SW[1] | ~SW[3]&SW[1]&SW[0];
